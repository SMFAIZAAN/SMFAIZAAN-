...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login("shaikhmdfaizaan4@gmail.com", "Smfaizaan")                ## Write email that you want to send from.   
    server.sendmail("shaikhmdfaizaan4@gmail.com", to, content)
    server.close()
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            try:
                ...
                content = takeCommand()
                to = "shaikhmdfaizaan@gmail.com"                  ## Write email that you want to send to.
