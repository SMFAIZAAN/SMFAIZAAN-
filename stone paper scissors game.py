...
# The Stone break the Scissor, the Paper grab the Stone , and Scissor cuts a Paper.
#
import random
lst = ['s','p','sc']
...
print("s for stone \np for paper \nsc for scissor \n")
print("Stone Paper Scissor Game, \nThe Stone break the Scissor,\n the Paper grab the Stone ,\n and Scissor cuts a Paper")
